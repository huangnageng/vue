...
com4j.config = {
    ...
    ForJoyH5_DefaultBigLogo: "default_b.png",
    _ForJoyH5_BigLogo: "default_b.png",
    ...
    ForJoyH5_DefaultSmallLogo: "./default_s.png",
    _ForJoyH5_SmallLogo: "./default_s.png",
...
com4j.moregames = {
    ...
    init: function() {
        ...
        var url = com4j.config.host + "moregames/" + com4j.config.NameID + ".json?v=" + now;
...
com4j.ad = {
    ...
    _init: function() {
        if (com4j.ad.intervalID == -1) {
            com4j.ad.intervalID = setTimeout(com4j.ad.onAdClose, 3e4)
        }
...
com4j.init = function() {
    ...
    com4j.config.init();
    com4j.config.ForJoyH5_DefaultBigLogo="default_b.png";
    com4j.config.ForJoyH5_DefaultSmallLogo="default_s.png";
    ...
    $.get(url, function(data, status, xhr) {
        ...
        // if (isRelease) {
        //     var url = "//h5.4j.com/ajax_addgameplay.php?" + "pubid=" + com4j.config.ForJoyH5_pubid + "&mid=" + com4j.config.ForJoyH5_mid + "&game=" + com4j.config.ForJoy_gameid + "";
        //     $.get(url)
        // }
        $(document.body).css("background", com4j.config.ForJoyH5_BgColor);
