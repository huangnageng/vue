...
start: function(a) {
    ...
    //                                                                           status: a
    //                                                                           })
    console.log("====levelStart:"+currentLevel);
    didstartGame();    
},
...
function showAdBannerInGame(){
  ...
  banner.innerHTML= '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><ins class="adsbygoogle"style="display:inline-block;width:320px;height:50px"data-ad-client="ca-pub-3545063517335060"data-ad-slot="3824364754"></ins><script>';
