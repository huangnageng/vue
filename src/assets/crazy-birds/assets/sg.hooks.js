...
start: function(a) {
    ...
    //                                                                           status: a
    //                                                                           })
    console.log("====levelStart:"+Global.level);
    didstartGame();    
},
...
levelStarted: function(a) {
    ...
    console.log("====levelStarted:"+currentLevel);
...
function didstartGame(){
    ...
    console.log("游戏开始了:"+currentLevel);
...
function didEndGame(){
    console.log("游戏结束了:"+(currentLevel));
   ga('send', 'event', {
    eventCategory: '游戏页',
    eventAction: '结束游戏',
    eventLabel:(currentLevel)
...
function showAdBannerInGame(){
  ...
  banner.innerHTML= '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><ins class="adsbygoogle"style="display:inline-block;width:320px;height:50px"data-ad-client="ca-pub-3545063517335060"data-ad-slot="3832259143"></ins>';
...
if(banner!=null){document.body.removeChild(banner);}

};

function reseizeBannerInGame(){
...
var banner = document.getElementById("bannerInBottom");
 ...
 function runGame (){
           ...
           command.action="runGame";
           startFunction(command);
           ga('send', 'event', {
           eventCategory: '介绍页',
           eventAction: '进入游戏',
           eventLabel:(0)
